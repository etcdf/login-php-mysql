...
<head>
    <meta charset="utf-8">
    <script src="../../vendor/bootstrap/color-modes.js"></script>
...
<body class="d-flex align-items-center py-4 bg-body-tertiary">
    ...
    <main class="form-signin w-100 m-auto">
        <form action="../Controllers/loginController.php" method="post">            
            <h1 class="h3 mb-3 fw-normal center">Entrar na conta</h1>            
            ...
            <p class="mt-3 mb-3 text-body-secondary">Não possui uma conta? <a href="register.php">Criar conta </a> Projeto base em PHP e MySQL</p>
        </form>
    </main>
    <!-- // Test -->
